...
export default function GoalCard({ taskData, donationData, eventId, userId, eventPercentage }) {
          ...
          <div className="p-6">
            <div>
              ...
              <dl className="mt-2 border-t border-b border-gray-200 divide-y divide-gray-200">
                {taskData.map((task) => {
                  const taskDonationHours = donationData.map((donation) => {
                ...
                console.log({sumOfTaskDonationHours})
                  return (
                  <div
                    key={task._id}
                  ...
                  >
                    ...
                    {sumOfTaskDonationHours} of {task.taskGoalHours} Hours
                    </dd>
                  </div>)
                }
               )}
